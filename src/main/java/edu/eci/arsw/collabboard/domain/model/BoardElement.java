    ...
    public BoardElement {
        ...
        if (type == ElementType.CONNECTOR) {
            ...
            if (sourceId != null || targetId != null) {
                throw new IllegalArgumentException("sourceId/targetId only apply to CONNECTOR elements");
            }
            if (type == ElementType.TEXT && text.isBlank()) {
                throw new IllegalArgumentException("Text elements require non-blank text");
            }
        }
    }
}